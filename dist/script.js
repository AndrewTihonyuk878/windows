...
var changeModalState = function changeModalState(state) {
  ...
  (0,_checkNumInputs__WEBPACK_IMPORTED_MODULE_2__["default"])('#width');
  (0,_checkNumInputs__WEBPACK_IMPORTED_MODULE_2__["default"])('#height');
        ...
        switch (item.nodeName) {
          ...
          case 'INPUT':
            if (item.getAttribute('type') === 'checkbox') {
              i === 0 ? state[prop] = "Холодное" : state[prop] = "Гарячее";
...
/* harmony import */ var _checkNumInputs__WEBPACK_IMPORTED_MODULE_18__ = __webpack_require__(/*! ./checkNumInputs */ "./src/js/modules/checkNumInputs.js");
...
var forms = function forms(state) {
  ...
  (0,_checkNumInputs__WEBPACK_IMPORTED_MODULE_18__["default"])('input[name="user_phone"]');
  var message = {
    loading: 'Загрузка...',
